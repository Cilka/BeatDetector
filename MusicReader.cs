...
namespace Beat_Detector
{
    class MusicReader
    {
        ...
        [STAThread]
        static public string prompt(bool save =false)
        {
            string filename = "";
            FileDialog fd = new OpenFileDialog();
            fd.Filter = "All Supported Files (*.wav,*mp3)|*.wav;*.mp3";
            ...
            {
                StreamReader s = new StreamReader(fd.FileName);
        ...
        [STAThread]
        public static string SaveInFolder() {
